...
export type StorageHash =
  StorageHashBase<'15c4a90ba629abaf1d1b773507ebac113c1afe0a7b7902ef37fd2ef495a48458'>;
export type ExecutionHash =
  ExecutionHashBase<'b49e774c4b130df64b75f29ca65641636342dd510155f70e55c00c67844ff761'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Course: { readonly id: Char<36>; readonly title: CodecTypes['pg/text@1']['output'] };
    readonly Entry: {
      readonly id: Char<36>;
      readonly authorId: Char<36>;
      readonly courseId: Char<36>;
      readonly statusId: Char<36>;
      readonly paymentTypeId: Char<36>;
    ...
    readonly Status: { readonly id: Char<36>; readonly title: CodecTypes['pg/text@1']['output'] };
    readonly User: {
      readonly id: Char<36>;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Entry: {
      ...
      readonly courseId: CodecTypes['sql/char@1']['input'];
      readonly statusId: CodecTypes['sql/char@1']['input'];
      readonly paymentTypeId: CodecTypes['sql/char@1']['input'];
          ...
          readonly Entry: {
            ...
            readonly relations: {
              ...
              readonly paymentType: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['paymentTypeId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly status: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly paymentTypeId: { readonly column: 'paymentTypeId' };
          ...
          readonly PaymentType: {
            ...
            readonly relations: {
              readonly entries: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['paymentTypeId'];
                };
              };
            };
            readonly storage: {
              readonly table: 'PaymentType';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly title: { readonly column: 'title' };
